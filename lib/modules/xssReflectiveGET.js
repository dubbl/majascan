...
majascan.xssReflectiveGET =
{
	outgoingRequest: function(context, url, postdata) {
		if (url != null) {
			...
			var searchResult = url.search(/('|"|%22|%27|\\x22|\\x27|\&#x27;|\&#x22;)+( |%20|\\x20|\&#x20;)*(on|%6f%6e|\\x6f\\x6e|\&#x6f;\&#x6e;)(\w|%\w\w|\\x\w\w|\&#x\w\w;)+(=|%3D|\\x3D|\&#x3D;)/i);
			if (searchResult != -1) {
				var response = new require("./../moduleResponse").getmoduleResponse();
			...
			// searching for js event handlers in an html tag context
			var searchResult = url.search(/(javascript|%6A%61%76%61%73%63%72%69%70%74|\&#x6A;\&#x61;\&#x76;\&#x61;\&#x73;\&#x63;\&#x72;\&#x69;\&#x70;\&#x74;|\\x6A\\x61\\x76\\x61\\x73\\x63\\x72\\x69\\x70\\x74)(:|%3a|\&#x3a;|\\x3a)/i);
			if (searchResult != -1) {
				var response = new require("./../moduleResponse").getmoduleResponse();
